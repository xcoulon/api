...
* Go version 1.16 - download for your development environment https://golang.org/dl/[here].
* Operator-sdk version 1.8.0 - download and install https://sdk.operatorframework.io/docs/install-operator-sdk[here]
